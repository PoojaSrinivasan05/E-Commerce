    ...
    <section className="py-10">
      <div className="container flex gap-5">
        <div className="leftCol w-[70%]">
          <div className="card bg-white shadow-md p-5 rounded-md w-full">
            ...
            <form className="w-full mt-5">
              ...
              <h6 className="text-[14px] font-[500] mb-3"> Address *</h6>
              <div className="flex items--center gap-5 pb-5">
        ...
        <div className="rightCol w-[30%]">
          <div className="cardshadow-md bg-white p-5 rounded-md">
            <h2>Your Order</h2>
              ...
              <div className="part1 flex items-center gap-3">
                <div className="img w-[50px] h-[50px] object-cover overflow-hidden rounded-md group cursor-pointer">
                  <img
                    ...
                    className="w-full transiion-all group-hover:scale-105"
                  />
                </div>
                <div className="info">
            ...
            <Button className="btn-org btn-lg w-full flex gap-2 items-center"><IoBagCheck className="text-[22px]" />Checkout</Button>
          </div>
        </div>
      </div>
    </section>
