      ...
      <section className="bg-white py-5">
        <div className="container flex gap-5">
          ...
          <div className="productContent w-[60%]">
            ...
            <p className="mt-3 mb-2 text-[14px]">Free Shipping (Est. Delivery Time 2-3 Days)</p>
            ...
            <div className="flex items-center mt-4 gap-4">
              ...
              <Button className="btn-org flex gap-2">< PiShoppingCartSimpleFill className="text-[22px]" />Add to Cart</Button>
            </div>
