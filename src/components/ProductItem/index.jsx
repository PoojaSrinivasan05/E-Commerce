    ...
    <div className='productItem shadow-lg rounded-md overflow-hidden border-1 border-[rgba(0,0,0,0.1)]'>
        <div className=" group imgWrapper w-[100%]   rounded-md relative">
            ...
            <div className="img   overflow-hidden">
                ...
                z-50 bg-primary text-black rounded-lg p-1 text-[10px] font-[500]">10%</span>
        ...
        <div className="info p-3 py-4 ">
            <h6 className='text-[14px]'><Link to="/" className='link' >CLAFOUTIS</Link></h6>
            <h3 className='text-[13px] font-[400]  mt-1 title text-rgba(0,0,0,0.9)'>
                 Men Opaque Casual Shirt</h3>
                <Rating name="size-small" defaultValue={5} size="small" readOnly />
                <div className="flex items-center gap-2">
                    <span className='oldPrice line-through text-gray-500 text-[12px]'>₹900</span>
