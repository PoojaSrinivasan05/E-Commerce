...
const Dashboard =()=>{
    ...
    return(
        ...
        <div className="w-full py-2 bg-white px-5 border border-[rgba(0,0,0,0.1)] flex items-center gap-8 mb-5 justify-between rounded-md">
            ...
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ5vHj-vSbynrZTu_jmsQC2Tuyb3E-UYOTNRA&s" className="w-[250px]" />
        </div>
        <DashboardBoxes/>
                              ...
                              <tbody>
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                                  ...
                                  <td class="px-6 py-4 font-[500]">
                                    <span className="text-primary font-[500]">345237d5235d36456</span>
                                  </td>
                                 
                                 <td class="px-6 py-4 font-[500]">
                                    <span className="text-primary font-[500]">pay_PTP6avhghsga98797</span>
                                  </td>
